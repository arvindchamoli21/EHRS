...
var EmployeeCount = /** @class */ (function () {
    function EmployeeCount() {
        ...
        this.countRadioButtonSelectionChanged = new core_1.EventEmitter(); /// Custom event using eventemitter
    }
